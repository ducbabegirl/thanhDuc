          ...
          <div class="container">
             <div id="sequence">
                ...
                <ul class="sequence-canvas">
                   <li class="animate-in">
                      <div class="flat-caption caption1 formLeft delay300 text-center"><span class="suphead" style="color: #000;">Paris show 2014</span></div>
                      <div class="flat-caption caption2 formLeft delay400 text-center">
                         <h1  style="color: #000;">Collection For Winter</h1>
                      </div>
                   ...
                   <li>
                      ...
                      <div class="flat-caption caption3 formLeft delay500">
                         <h2  style="color: #000;">Etiam velit purus, luctus vitae velit sedauctor<br>egestas diam, Etiam velit purus.</h2>
                      </div>
                   ...
                   <li>
                      ...
                      <div class="flat-button caption4 formLeft delay600 text-center"  style="color: #000;"><a class="more" href="#">More Details</a></div>
